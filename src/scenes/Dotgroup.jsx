...
export function DotGroup({ selectedPage, setSelectedPage }) {
  const selectedStyles = `reltive bg-yellow before:absolute before:w-6 before:h-6 before:rounded-full before:border-2 before:border-yellow before:left-[-50%] before:top-[-50%]`;
  return (
